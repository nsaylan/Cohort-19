...
```bash
docker login -u admin -p admin 54.242.128.135:8082 # don't forget to change password.
docker pull 54.242.128.135:8082/alpine
docker image ls
```
...
```bash
docker login -u admin -p admin 54.242.128.135:8083
docker pull 54.242.128.135:8082/nginx
docker image ls
docker tag 54.242.128.135:8082/nginx 54.242.128.135:8083/myng
docker push 54.242.128.135:8083/myng
```
